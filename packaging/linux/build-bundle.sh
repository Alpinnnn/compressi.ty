...
cp "${REPO_ROOT}/assets/icon/icon.svg" "${APPDIR}/io.github.Alpinnnn.Compressity.svg"
cp "${REPO_ROOT}/assets/icon/icon.svg" "${APPDIR}/usr/share/icons/hicolor/scalable/apps/io.github.Alpinnnn.Compressity.svg"
